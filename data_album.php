      ...
      <div class="heading_container heading_center">
	   ...
	   <div class="row">
        <div class="col-md-12">
		  ...
		  <br>
		   <a href="print_dataalbum.php">+print dataalbum</a>
		  ...
		  <tbody  align="center">
			...
			<tr>
				...
				<td>
				<?php echo '
				  <a href="delete_album_admin.php?AlbumID='.$data['AlbumID'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
				  ';?> </td>
